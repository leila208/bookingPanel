...
const renderCalendar = () => {
  ...
  const today = new Date(); // bugunun tarixi
  ...
  for (let i = 1; i <= lastDateofaMonth; i++) {
    ...
    const isSelectable =
      currentDateStr === todayStr || dateArray.includes(currentDateStr);
...
const openModalBtn = document.getElementById("confirmBtn"); 
